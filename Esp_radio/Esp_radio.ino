...
Adafruit_PCD8544 display = Adafruit_PCD8544(14, 13, 2, 15, 0);
...
bool connectwifi()
{
  ...
  WiFi.begin ("Neptune", "Datamini!2345");
...
//  display.setCursor(0,0);
  ...
  display.clearDisplay();
  display.println("Loading stations complete");
  display.display();
  delay(500); 
  ...
  display.clearDisplay();
  display.println("Initializing player");
  display.display();
  delay(500); 
